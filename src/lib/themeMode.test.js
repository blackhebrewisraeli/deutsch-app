...
describe('resolveThemeMode', () => {
  ...
  it('uses prefers-color-scheme when preference is unset', () => {
...
describe('system preference watching', () => {
  ...
  it('getThemeModeForUI resolves to the system mode when nothing is stored', () => {
    expect(getThemeModeForUI()).toBe('light');
  });

  it('re-applies when OS scheme changes while no explicit preference is stored', () => {
