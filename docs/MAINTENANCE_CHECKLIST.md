...
| Chat → change scenario | The scene character opens in role (e.g. a barista for Order Coffee) at the classified level, and the task resets. At A1 the composer shows word blocks built from the AI's suggestion. |
