...
//
// avatar_emoji was dropped the same way: the active fallback is the identicon,
// production had zero non-empty values, and the column stays so we never need
// a DROP COLUMN migration.
